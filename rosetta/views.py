        ...
        if '_next' in request.POST:
            ...
            if file_change and rosetta_i18n_write:
                try:
                    ...
                    rosetta_i18n_pofile.metadata['Last-Translator'] = unicodedata.normalize('NFKD', "%s %s <%s>" % (request.user.first_name, request.user.last_name, request.user.email)).encode('ascii', 'ignore')
